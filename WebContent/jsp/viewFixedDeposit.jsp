...
<% FixedDeposit fd = (FixedDeposit)session.getAttribute("deposit");
  ...
  <tr><td>Account Number:<%=fd.getAccountNo()%></td></tr>
  <tr><td>Tenure:<%=fd.getTenure() %></td></tr>
  <tr><td>Amount:<%=fd.getAmount() %></td></tr>
  <tr><td>Deposit Date:<%= fd.getDepositDate() %></td></tr>
  <tr><td>Maturity Date:<%=maturityDate%></td></tr>
  <tr><td>Interest Rate:<%=interestRate %></td></tr>
  <tr><td>Auto_Renewal:<%= fd.getAutoRenewal()%></td></tr></table>
...
<td>
  ...
  <tr>
      ...
      <input type="hidden" value="submission" name="action"></input>
       <input type="submit" value="YES"></input></form></td></tr></table></td>
       <td>
      <table><tr><td>
       <form action="<%= request.getContextPath() %>/customerServlet">
        <input type="hidden" value="cancellation" name="action"></input>
