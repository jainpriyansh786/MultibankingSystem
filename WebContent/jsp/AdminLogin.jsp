...
<div id="header" class="header">
	...
	<div id="update"><a href="<%=request.getContextPath() %>/HomePage.jsp"><img
				src="<%=request.getContextPath()%>/images/home.jpg" title="home page"></a></div>	
	...
	<div style="text-align: center;">
		<div
			...
			<div
				...
				<span
					style="font-family: verdana, arial; color: #D4D4D4; font-size: 1.00em; font-weight: bold;">Admin Login
					</span>
			</div>
...
%>
				...
				<form method="post"
					...
					name="AdminLogin" target="_top" onsubmit=" return validate10()">

					<table class='center'>

						<tr>
							<td>AdminId:</td>
							<td><input type="text" name="adminLogin" id="adminLogin"placeholder="AdminId"></td>
							<td></td>
							<td><span id="adminlogin1"></span></td>
						</tr>
						<tr>
							<td>Password:</td>
							<td><input type="password" name="adminpassword"
								id="adminpassword"placeholder="Password"></td>
							<td><%= error %></td>
							<td><span id="adminpassword1"></span></td>
						</tr>
						<tr><td></td></tr>
						<tr>
							<td>&nbsp;</td>
							<td><input type="submit" value="login"><input
								type="hidden" name="action" value="adminLogin"></td>
						</tr>
						<tr>
							<td colspan=2>&nbsp;</td>
						</tr>
