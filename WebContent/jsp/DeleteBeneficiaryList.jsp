...
ArrayList<Beneficiary> beneficiaries1 =  (ArrayList<Beneficiary>)request.getAttribute("beneficiary");



if(beneficiaries1.size()>0){
 %> 
...
%>
 ...
 <table class="priyansh" id="priyansh" bgcolor="#FFFFFF">
  ...
  <th>IFSC Code</th>
  <th>Email</th></tr>
  <% for(Beneficiary beneficiary:beneficiaries1){ %>

  <tr>
  <td><input type="radio" name= "radioselected4" value=<%= beneficiary.getAccountNo() %>></td>
  ...
  <table>
  <tr>
  <td>No Beneficiaries to delete</td></tr></table>
  <%} %>
