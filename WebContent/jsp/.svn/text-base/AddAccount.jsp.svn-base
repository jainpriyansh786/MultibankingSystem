...
<%-- <div id="menu" class="menu">
	...
	<div style="text-align: center;">
		<div
			style="box-sizing: border-box; display: inline-block; width: 630; max-width: 630px; background-color: #FFFFFF; border: 2px solid #00628B; border-radius: 5px; box-shadow: 0px 0px 8px #0361A8; margin: 180px auto auto;">
			<div
				style="background: #00628B; border-radius: 5px 5px 0px 0px; padding: 15px;">
				<span
					style="font-family: verdana, arial; color: #D4D4D4; font-size: 1.00em; font-weight: bold;">Add Account</span>
			</div>
...
%>
				<form method="post" action="<%=request.getContextPath() %>/customerServlet" name="addAccount"
					...
					<table class='center'>
						...
						<tr>
							<td>AccountNo:</td>
							<td><input type="text" name="accountNo" id="accountNo" placeholder="12345"  maxlength="6" required></td>
							<td></td>
							<td><span id="accountNo1"></span></td>
						</tr>
						<tr>
							<td>BankName:</td>
							<td><input type="text" name="bankNameAccount" id="bankNameAccount" placeholder="Letters"  maxlength="10" required></td>
							<td></td>
							<td><span id="bankNameAccount1"></span></td>
						</tr>
						<tr>
							<td>BranchName:</td>
							<td><input type="text" id="branchNameAccount"name="branchNameAccount"placeholder="Letters"  maxlength="10" required ></td>
							<td></td>
							<td><span id="branchName1"></span></td>
						</tr>
						<tr>
							<td>IfscCode:</td>
							<td><input type="text" id="ifscCodeAccount"  name="ifscCodeAccount"placeholder="Numeric"    maxlength="5" required></td>
							<td></td>
						...
						<tr>
							...
							<td><input type="submit" value="Add"><input
								type="hidden" name="action" value="addAccount"></td>
						</tr>
						<tr>
							<td colspan=2>&nbsp;</td>
						</tr>
