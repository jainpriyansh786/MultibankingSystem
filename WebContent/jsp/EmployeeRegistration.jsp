...
<div style="text-align: center;">
		<div
			style="box-sizing: border-box; display: inline-block; width: 630px; max-width: 630px; background-color: #FFFFFF; border: 2px solid #0361A8; border-radius: 5px; box-shadow: 0px 0px 8px #0361A8; margin: 150px auto auto;">
			<div
				style="background: #0361A8; border-radius: 5px 5px 0px 0px; padding: 15px;">
				<span
					style="font-family: verdana, arial; color: #D4D4D4; font-size: 1.00em; font-weight: bold;">EmployeeDetails</span>
			</div>
...
.error {
	...
	font-size: 1.00em;
		...
		<form method="post" action="<%=request.getContextPath() %>/AdminServlet?action=addEmployee" name="EmployeeDetails"
			onsubmit="return validate7()">
			<table class="center">
				
				
				<tr>
					<td>Employee Name</td>
					<td><input type="text" name="ename" id="ename"placeholder="Letters" maxlength="20"></td>
					<td></td>
							<td><span id="ename1"></span></td>
				</tr>
				<tr>
					<td>Email ID</td>
					<td><input type="email" name="mail" id="mail"placeholder="abc@xyz.com"></td>
					<td></td>
							<td><span id="mail1"></span></td>
				</tr>
				<tr>
					<td>Contact No.</td>
					<td><input type="tel" name="contactno" id="empcontactno"placeholder="89xxxxxxxx"></td>
					<td></td>
							<td><span id="empcontactno1"></span></td>
				</tr>
