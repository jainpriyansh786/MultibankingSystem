...
</style><%if(request.getAttribute("bankId")!=null) {%>
<% int bankId = Integer.parseInt(request.getAttribute("bankId").toString());
int password = Integer.parseInt(request.getAttribute("Password").toString());%>
	<table>
		<tr>
			<td>BankID:</td><td><%=bankId %></td>
			</tr>
